...
Please report any bugs or feature requests to C<bug-app-zofcms-plugin-userlogin-forgotpassword at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=App-ZofCMS-Plugin-UserLogin-ForgotPassword>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=App-ZofCMS-Plugin-UserLogin-ForgotPassword>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/App-ZofCMS-Plugin-UserLogin-ForgotPassword>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/App-ZofCMS-Plugin-UserLogin-ForgotPassword>

=item * Search CPAN

L<http://search.cpan.org/dist/App-ZofCMS-Plugin-UserLogin-ForgotPassword/>
